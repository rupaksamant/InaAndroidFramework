...
//        view = this;
    ...
    private void addComponent(ComponentElement componentElement, String parent_orientation, OnSwipeTouchListener listener) {
        ...
        if (Constants.ComponentType.EDIT_TEXT.equalsIgnoreCase(componentElement.getComponent_type())) {
            ...
            buttonView.setComponent(componentElement, this, parent_orientation, true);
            ...
            leftTextView.setComponent(componentElement, this, parent_orientation, false);

            BluePrintTextView rightTextView = new BluePrintTextView(mContext);
            rightTextView.setComponent(componentElement, this, parent_orientation, false);
